...
class TestScrollableRadiobuttonFrame(unittest.TestCase):
    ...
    def test_add_item_empty(self) -> None:
        ...
        mock_tkinter_radiobutton1.pack.assert_called_once_with(anchor='w')
        mock_tkinter_radiobutton1.configure.assert_called_once_with(command='command')
        self.assertEqual(self.scrollable_radiobutton_frame_cls.recordings_radiobutton_list, [mock_tkinter_radiobutton1])
    ...
    def test_add_item_not_empty(self) -> None:
        ...
        mock_tkinter_radiobutton3 = MagicMock()
        customtkinter.CTkRadioButton = MagicMock(return_value=mock_tkinter_radiobutton3)
        self.scrollable_radiobutton_frame_cls.add_item('file')
        mock_tkinter_radiobutton3.pack.assert_called_once_with(anchor='w')
        mock_tkinter_radiobutton3.configure.assert_called_once_with(command='command')
        self.assertEqual(self.scrollable_radiobutton_frame_cls.recordings_radiobutton_list,
                         [mock_tkinter_radiobutton1, mock_tkinter_radiobutton2, mock_tkinter_radiobutton3])

    def test_clear_list_empty(self) -> None:
        self.scrollable_radiobutton_frame_cls.recordings_radiobutton_list = []
        self.scrollable_radiobutton_frame_cls.clear_list()
        mock_tkinter_radiobutton1.destroy.assert_not_called()
        self.assertEqual(self.scrollable_radiobutton_frame_cls.recordings_radiobutton_list, [])

    def test_clear_list_not_empty(self) -> None:
        self.scrollable_radiobutton_frame_cls.recordings_radiobutton_list = not_empty_radiobutton_list
        self.scrollable_radiobutton_frame_cls.clear_list()
        mock_tkinter_radiobutton1.destroy.assert_called_once_with()
        self.assertEqual(self.scrollable_radiobutton_frame_cls.recordings_radiobutton_list, [])
