...
class TestPiano(unittest.TestCase):
    ...
    @patch.object(Piano, '_remove_piano_key_highlight')
    @patch('time.sleep')
    ...
    def test_play_key(self, mock_pygame_mixer: MagicMock, mock_update_piano_recorder_key: MagicMock,
                      mock_time_sleep: MagicMock, mock_remove_piano_key_highlight: MagicMock) -> None:
        ...
        mock_remove_piano_key_highlight.assert_called_once_with('q')
