...
class TestMemoSong(unittest.TestCase):
    ...
    def test_add_update_file_frame(self, mock_create_label: MagicMock, mock_create_control_button: MagicMock) -> None:
        ...
        #     call(mock_tkinter_frame, 'Rename', self.memo_song.file_manager.edit_file(), width=70),
        #     call(mock_tkinter_frame, 'Delete', self.memo_song.file_manager.edit_file(), width=70)
        #     ])
    ...
    def test_add_piano_recorder_title_frame(self, mock_create_label: MagicMock,
                                            mock_create_button_from_image: MagicMock) -> None:
        self.memo_song.add_piano_recorder_title_frame(mock_tkinter_frame)
        ...
        mock_create_button_from_image.assert_has_calls([
            call(mock_tkinter_frame, 'keyboard', (45, 25), self.memo_song._turn_keyboard_piano, 'left', self.memo_song),
            call(mock_tkinter_frame, 'mute', (25, 25), self.memo_song._mute_playback, 'right', self.memo_song)
        ])
    ...
    def test_play_pressed_key(self, mock_highlight_button: MagicMock, mock_play_key: MagicMock) -> None:
        ...
        self.memo_song._play_pressed_key(mock_event)
    ...
    def test_play_key_repeated_key(self, mock_piano_play_key: MagicMock, mock_start_new_thread: MagicMock,
        ...
        self.assertEqual(self.memo_song.piano.key, 'q')
    ...
    def test_play_key_changed_key(self, mock_piano_play_key: MagicMock, mock_start_new_thread: MagicMock,
        ...
        self.assertEqual(self.memo_song.piano.key, '2')
        mock_start_new_thread.assert_called_once_with(mock_piano_play_key)
    ...
    def test_configure_file_browser(self, mock_create_main_frame: MagicMock, mock_create_label: MagicMock,
        ...
        mock_tkinter_frame.reset_mock()
        mock_tkinter_entry.reset_mock()
        self.memo_song.configure_file_browser('recordings', 2)
        ...
        # mock_create_control_button.assert_has_calls([
        #     call(mock_tkinter_frame, 'Search', self.memo_song.file_manager.search_recordings, 'left', width=1),
        #     call(mock_tkinter_frame, 'Update List', self.memo_song.file_manager.update_list, 'bottom')])
        mock_create_radiobutton_list.assert_called_once_with(mock_tkinter_frame, 'recordings',
                                                             self.memo_song.recording_manager.play_recording)
        self.assertEqual(getattr(self.memo_song.file_manager, 'recordings_search_field'), mock_tkinter_entry)
    ...
    def test_create_radiobutton_list_recordings(self, mock_create_radiobutton_list: MagicMock) -> None:
        self.memo_song._create_radiobutton_list(mock_tkinter_frame, 'recordings', 'command')
        mock_create_radiobutton_list.assert_called_once_with(mock_tkinter_frame, 'recordings', 'command')
        self.assertEqual(self.memo_song.file_manager.recordings_radiobutton_list, 'radiobutton_list')
    ...
    def test_create_radiobutton_list_notes(self, mock_create_radiobutton_list: MagicMock) -> None:
        self.memo_song._create_radiobutton_list(mock_tkinter_frame, 'notes', 'command')
        mock_create_radiobutton_list.assert_called_once_with(mock_tkinter_frame, 'notes', 'command')
        self.assertEqual(self.memo_song.file_manager.notes_radiobutton_list, 'notes_list')
    ...
    def test_configure_notepad(self, mock_create_main_frame: MagicMock, mock_create_label: MagicMock,
        ...
        mock_tkinter_frame.reset_mock()
        self.memo_song.configure_notepad()
        ...
        mock_tkinter_frame.pack.assert_called_once_with(side='top', fill='both')
        mock_create_control_button.assert_has_calls([
            call(mock_tkinter_frame, 'Save', self.memo_song.note_manager.save_note, 'left', width=1),
            call(mock_tkinter_frame, 'Clear Notepad', self.memo_song.note_manager.clear_notepad, 'bottom')
        ])
    ...
    def test_setup_notepad(self) -> None:
        ...
        self.assertEqual(self.memo_song.file_manager.notepad_title_field, mock_tkinter_entry)
        self.assertEqual(self.memo_song.file_manager.notepad_text_area, mock_tkinter_textbox)
    ...
    def test_configure_piano(self, mock_create_main_frame: MagicMock, mock_is_white_key: MagicMock,
        ...
        self.memo_song.configure_piano()
    ...
    def test_create_piano_button(self, mock_add_key_names: MagicMock) -> None:
        ...
        self.assertEqual(getattr(self.memo_song, 'q_key'), mock_tkinter_button)
